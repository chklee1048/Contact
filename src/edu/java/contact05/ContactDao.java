...
/*
 * MVC(Model-View-Controller) 컨트롤러 역할을 수행
...
public interface ContactDao {
	 ...
	 * @param contact 리스트에 저장할 연락처 객체
	 * @return 리스트 저장 성공하면 1을 리턴, 실패하면 0을 리턴
	 */
	int create(Contact contact);
	
	
	/**
	 * 연락처 전체 목록 보기 가능. 저장된 연락처 개수 크기의 연락처 리스트를 리턴. 
	 * @return 연락처 리스트(Contact[])
	 */
	List<Contact> read();
	...
	/**
	 * 인덱스 수정 기능
	 * @param index 수정할 연락처 인덱스. 0이상이고 저장된 연락처 개수보다 작은 정수
